...
@Service
public class ContentCategoryItemServiceImpl implements ContentCategoryItemService {
	...
	public TaotaoResult insertContentCategory(long parentId, String name) {
		...
		TbContentCategory parentContentCategory = this.contentCategoryMapper.selectByPrimaryKey(parentId);
	...
	public TaotaoResult deleteContentCategory(long parentId, long nodeId) throws Exception {
		...
		if (list != null && !list.isEmpty()) {
			...
			// 需要改动parentNode属性
			TbContentCategory parentNode = this.contentCategoryMapper.selectByPrimaryKey(parentId);
